...
public class EditComplaint_1 extends JFrame implements MenuKeyListener, javax.swing.event.MenuListener, KeyListener{
	...
	public EditComplaint_1(String title)throws HeadlessException {
		 super(title);
		 setResizable(true);
		 addComponents();
		 menu();
	...
	public static void main(String[] args) {
		...
		new EditComplaint_1("Edit Complaint");
